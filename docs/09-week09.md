...
```
## the	1 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0017e602b137e88.txt
```

```
## quick	2 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0027e604fa83778.txt
```

```
## brown	3 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0037e60bc634af.txt
```

```
## fox	4 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0047e60195772f.txt
```

```
## jumps	5 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0057e60229c264.txt
```

```
## over	6 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0067e606cfd4207.txt
```

```
## the	7 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0077e601b5b742d.txt
```

```
## lazy	8 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0087e604c1a30c5.txt
```

```
## dog	9 of 9; file = C:/Temp/5/RtmpshZ3mx/str_0097e6038323213.txt
```
...
```
## [1] "some Europe: 314 159 265,358979"
```
...
```
## [1] "other Europe: 314'159'265,358979"
```
...
equals approximately 314,159,265.358979."
```
appears as:

For example, used in inline code: "$\pi$ multiplied by `r `format(1e+8, scientific = FALSE)` equals approximately 314,159,265.358979."
...
```
## the	1 of 9:	C:\Temp\5\RtmpshZ3mx/str_0017e602b137e88.txt
## quick	2 of 9:	C:\Temp\5\RtmpshZ3mx/str_0027e604fa83778.txt
## brown	3 of 9:	C:\Temp\5\RtmpshZ3mx/str_0037e60bc634af.txt
## fox	4 of 9:	C:\Temp\5\RtmpshZ3mx/str_0047e60195772f.txt
## jumps	5 of 9:	C:\Temp\5\RtmpshZ3mx/str_0057e60229c264.txt
## over	6 of 9:	C:\Temp\5\RtmpshZ3mx/str_0067e606cfd4207.txt
## the	7 of 9:	C:\Temp\5\RtmpshZ3mx/str_0077e601b5b742d.txt
## lazy	8 of 9:	C:\Temp\5\RtmpshZ3mx/str_0087e604c1a30c5.txt
## dog	9 of 9:	C:\Temp\5\RtmpshZ3mx/str_0097e6038323213.txt
```
...
```
## writing subject a1's data to C:\Temp\5\RtmpshZ3mx/a1.csv
```

```
## writing subject b2's data to C:\Temp\5\RtmpshZ3mx/b2.csv
```

```
## writing subject c3's data to C:\Temp\5\RtmpshZ3mx/c3.csv
```
...
## write.csv(x = y, file = file.path(tempdir(), '00501.csv'), row.names = FALSE)
```
...
<caption>(\#tab:iris)Mean sepal length from the iris data set</caption>
 <thead>
  <tr>
   ...
   <th style="text-align:right;"> mean_sepal_width </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
<table class="table" style="width: auto !important; ">
<caption>(\#tab:iris2)Mean sepal length from the iris data set (tidyverse approach)</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> species </th>
   <th style="text-align:right;"> mean_sepal_length </th>
...
```
## [1] "Saturday, March 12, 2022  9:03 AM PST"
```
...
```
## Time difference of 5.004148 secs
```
...
```
## Time difference of 19228.07 days
```
...
It took 29.1 s to write 41823590 bytes as CSV, and 0.3 s to write 19064839 bytes as a FST file (with the default compression amount of 50). Reading speeds are comparable.
...
##  [1] RVerbalExpressions_0.1.0 sf_1.0-7                 htmltools_0.5.2         
##  [4] leaflet_2.1.0            tidycensus_1.1.2         fstcore_0.9.8           
##  [7] fst_0.9.8                lubridate_1.8.0          sqldf_0.4-11            
## [10] RSQLite_2.2.10           gsubfn_0.7               proto_1.0.0             
## [13] curl_4.3.2               haven_2.4.3              kableExtra_1.3.4.9000   
## [16] knitr_1.37               magrittr_2.0.2           forcats_0.5.1           
## [19] stringr_1.4.0            dplyr_1.0.8              purrr_0.3.4             
## [22] readr_2.1.2              tidyr_1.2.0              tibble_3.1.6            
## [25] ggplot2_3.3.5            tidyverse_1.3.1         
## 
## loaded via a namespace (and not attached):
##  [1] fs_1.5.2           bit64_4.0.5        RColorBrewer_1.1-2 webshot_0.5.2     
##  [5] httr_1.4.2         tools_4.1.2        backports_1.4.1    bslib_0.3.1       
##  [9] rgdal_1.5-28       utf8_1.2.2         R6_2.5.1           KernSmooth_2.23-20
## [13] DBI_1.1.2          colorspace_2.0-3   sp_1.4-6           withr_2.5.0       
## [17] tidyselect_1.1.2   downlit_0.4.0      bit_4.0.4          compiler_4.1.2    
## [21] chron_2.3-56       cli_3.2.0          rvest_1.0.2        xml2_1.3.3        
## [25] bookdown_0.24.4    sass_0.4.0         scales_1.1.1       classInt_0.4-3    
## [29] proxy_0.4-26       rappdirs_0.3.3     systemfonts_1.0.4  digest_0.6.29     
## [33] foreign_0.8-82     rmarkdown_2.13     svglite_2.1.0      pkgconfig_2.0.3   
## [37] dbplyr_2.1.1       fastmap_1.1.0      highr_0.9          htmlwidgets_1.5.4 
## [41] rlang_1.0.2        readxl_1.3.1       rstudioapi_0.13    farver_2.1.0      
## [45] jquerylib_0.1.4    generics_0.1.2     jsonlite_1.8.0     crosstalk_1.2.0   
## [49] Rcpp_1.0.8         munsell_0.5.0      fansi_1.0.2        lifecycle_1.0.1   
## [53] stringi_1.7.6      yaml_2.3.5         maptools_1.1-3     grid_4.1.2        
...
## [73] gtable_0.3.0       assertthat_0.2.1   cachem_1.0.6       xfun_0.30         
## [77] broom_0.7.12       e1071_1.7-9        class_7.3-20       viridisLite_0.4.0 
## [81] tigris_1.6         memoise_2.0.1      units_0.8-0        ellipsis_0.3.2
```
...
<hr>
Rendered at <tt>2022-03-12 09:41:15.786</tt>

## Source code
File is at CSDE-TS1: R:/Project/CSDE502/2022/csde502-winter-2022-main/09-week09.Rmd.
