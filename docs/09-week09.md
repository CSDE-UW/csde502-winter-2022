...
```
## the	1 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0017e602b137e88.txt
```

```
## quick	2 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0027e604fa83778.txt
```

```
## brown	3 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0037e60bc634af.txt
```

```
## fox	4 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0047e60195772f.txt
```

```
## jumps	5 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0057e60229c264.txt
```

```
## over	6 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0067e606cfd4207.txt
```

```
## the	7 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0077e601b5b742d.txt
```

```
## lazy	8 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0087e604c1a30c5.txt
```

```
## dog	9 of 9; file = C:/Temp/6/RtmpGs1PWG/str_0097e6038323213.txt
```
...
## dog	9 of 9:	C:\Temp\6\RtmpGs1PWG/str_0097e6038323213.txt
```
...
```
## writing subject a1's data to C:\Temp\6\RtmpGs1PWG/a1.csv
```

```
## writing subject b2's data to C:\Temp\6\RtmpGs1PWG/b2.csv
```

```
## writing subject c3's data to C:\Temp\6\RtmpGs1PWG/c3.csv
```
...
```
## [1] "Friday, March 04, 2022 12:03 AM PST"
```
...
```
## Time difference of 5.005143 secs
```
...
```
## Time difference of 19219.7 days
```
...
It took 30.5 s to write 41823590 bytes as CSV, and 0.3 s to write 19064839 bytes as a FST file (with the default compression amount of 50). Reading speeds are comparable.
...
<hr>
Rendered at <tt>2022-03-04 00:46:39.095</tt>
