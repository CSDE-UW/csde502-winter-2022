...
```
## the	1 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0017e602b137e88.txt
```

```
## quick	2 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0027e604fa83778.txt
```

```
## brown	3 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0037e60bc634af.txt
```

```
## fox	4 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0047e60195772f.txt
```

```
## jumps	5 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0057e60229c264.txt
```

```
## over	6 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0067e606cfd4207.txt
```

```
## the	7 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0077e601b5b742d.txt
```

```
## lazy	8 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0087e604c1a30c5.txt
```

```
## dog	9 of 9; file = C:/Temp/5/Rtmpkrvg2J/str_0097e6038323213.txt
```
...
```
## the	1 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0017e602b137e88.txt
## quick	2 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0027e604fa83778.txt
## brown	3 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0037e60bc634af.txt
## fox	4 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0047e60195772f.txt
## jumps	5 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0057e60229c264.txt
## over	6 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0067e606cfd4207.txt
## the	7 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0077e601b5b742d.txt
## lazy	8 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0087e604c1a30c5.txt
## dog	9 of 9:	C:\Temp\5\Rtmpkrvg2J/str_0097e6038323213.txt
```
...
```
## writing subject a1's data to C:\Temp\5\Rtmpkrvg2J/a1.csv
```

```
## writing subject b2's data to C:\Temp\5\Rtmpkrvg2J/b2.csv
```

```
## writing subject c3's data to C:\Temp\5\Rtmpkrvg2J/c3.csv
```
...
```
## [1] "Friday, March 11, 2022  4:03 PM PST"
```
...
```
## Time difference of 5.005157 secs
```
...
```
## Time difference of 19227.34 days
```
...
It took 36.6 s to write 41823590 bytes as CSV, and 0.3 s to write 19064839 bytes as a FST file (with the default compression amount of 50). Reading speeds are comparable.
...
<hr>
Rendered at <tt>2022-03-11 16:07:51.315</tt>
