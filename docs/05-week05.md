...
<img src="05-week05_files/figure-html/unnamed-chunk-6-1.png" width="672" />
\    
*Figure  1: Live births x 1 million: Japan, Lithuania, USA (note non-standardized Y scale)*

## Git {#git}

is a brief introduction to [Git](https://git-scm.com/), the free and open source version control system for text-based files. Much of the material in this lesson is derived from the [Software Carpentry Git tutorial](https://swcarpentry.github.io/git-novice/).
...
<hr>
Rendered at <tt>2022-02-03 01:19:01</tt>
