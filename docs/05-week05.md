...
<hr>
Rendered at <tt>2022-01-27 22:58:37</tt>
...
The HFD is back!
This time, weâ€™ll be adding the period, cohort, and other synthetic indicators for all birth orders combined, and by birth order, such as those listed here for the USA (as before, you can figure out the naming convention of a given dataset by clicking on a dataset you want to show them to see its item naming convention, which is the suffix of the file name after the country code): https://www.humanfertility.org/cgi-bin/country.php?country=USA&tab=si

Iâ€™ll teach them what these datasets contain, and theyâ€™ll see it in their problem sets, too. For your part, please just remind them that they can access HFD data for both age-specific rates and summary indicators this way.
