...
```
## Deleting source `C:\Temp\5\RtmpIfCC0c/counties.gpkg' failed
## Writing layer `us_counties_2019' to data source 
##   `C:\Temp\5\RtmpIfCC0c/counties.gpkg' using driver `GPKG'
...
<hr>
Rendered at <tt>2022-03-11 18:03:14</tt>

## Source code
File is at CSDE-TS1: R:/Project/CSDE502/2022/csde502-winter-2022-main/04-week04.Rmd.
