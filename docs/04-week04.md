...
```
## Deleting source `C:\Temp\8\RtmpacMlI4/counties.gpkg' failed
## Writing layer `us_counties_2019' to data source 
##   `C:\Temp\8\RtmpacMlI4/counties.gpkg' using driver `GPKG'
...
<hr>
Rendered at <tt>2022-02-03 01:18:45</tt>
