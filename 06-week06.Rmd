...
A zipped file containing the metadata files for the public use Add Health data is available as [wave1_metadata.zip](data/wave1_metadata.zip). Download the file and unzip it in an appropriate location.
